        ...
        <div className="p-6 bg-gradient-to-r from-teal-100 to-cyan-100 rounded-2xl">
          ...
          <div className="gap-4 md:grid-cols-2">
            <div className="flex items-center ">
              ...
              {/* <div className="flex-1 h-2 mx-3 bg-white rounded-full">
                    <div
              ...
              <p className="pl-4 mb-1 text-sm font-medium text-gray-700">
                {getPersonalityDescription()}  {personalityType.description}
              </p>
      ...
      <div className="p-8 bg-white shadow-xl rounded-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            We'll create a virtual try-on with jewelry that matches your
            personality
          </p>
        </div>
        ...
        <div
          className={`relative border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-200 ${
            dragActive
              ...
              : "border-gray-300 hover:border-teal-500 hover:bg-teal-25"
          }`}
          ...
          {preview ? (
            <div className="space-y-4">
              <img
                src={preview}
                alt="Preview"
                className="max-w-xs mx-auto rounded-lg shadow-md max-h-64"
              />
