...
//   const getTopTraits = () => {
//     return Object.entries(personality.traits)
//       .sort(([, a], [, b]) => b - a)
//       .slice(0, 3)
//       .map(([trait, value]) => ({
...
//     const colors = {
//       openness: 'from-teal-600 to-cyan-500',
//       conscientiousness: 'from-blue-500 to-cyan-500',
//       extraversion: 'from-emerald-500 to-teal-500',
//       agreeableness: 'from-green-500 to-emerald-500',
//       neuroticism: 'from-orange-500 to-red-500'
//     };
//     return colors[trait] || 'from-gray-500 to-gray-600';
//   };
        ...
        <div className="overflow-hidden bg-white shadow-xl rounded-2xl">
          ...
          <div className="p-6">
            ...
            <div className="flex mt-4 space-x-3">
              <button className="flex items-center justify-center flex-1 py-3 space-x-2 font-semibold text-white transition-all duration-200 bg-gradient-to-r from-teal-700 to-cyan-600 rounded-xl hover:from-teal-800 hover:to-cyan-700">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-white shadow-xl rounded-2xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-gray-900 capitalize">{jewelry.name}</h3>
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900 capitalize">{jewelry.type}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Material:</span>
                <span className="font-semibold text-gray-900">{jewelry.materials[0]},{jewelry.materials[1]}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Price:</span>
                <span className="font-semibold text-gray-900 ">LKR {jewelry.basePrice}</span>
              </div>
            </div>
          ...
          <div className="p-6 bg-white shadow-xl rounded-2xl">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Your Personality</h3>
            </div>

            <div className="space-y-4">
              
                <div key={personalityType.personality} className="relative">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-gray-900">{personalityType.personality}</span>
              ...
              <p className="mt-2 text-sm text-gray-600">{personalityType.description}</p>
            </div>
                </div>
