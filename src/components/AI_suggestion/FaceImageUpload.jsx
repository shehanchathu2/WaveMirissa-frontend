  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-12 text-center">
        <h2 className="mb-6 text-5xl font-bold text-slate-900">Discover Your Perfect Jewelry Match</h2>
        <p className="max-w-3xl mx-auto text-xl leading-relaxed text-slate-600">
          Upload a clear photo of your face and let our AI analyze your unique features to recommend jewelry that perfectly complements your natural beauty
        </p>
      </div>
