...
import AddProductModal from '../../components/admin/AddProductModel'; // adjust path if needed
...
const Products = () => {
  ...
  return (
    <div className="p-6">
      ...
      <button className="bg-blue-500 text-white px-4 py-2 rounded mb-6 hover:bg-blue-600 transition" onClick={() => setShowModal(true)}>
        Add Product
      </button>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <td className="px-6 py-4 text-sm text-center">
                <span
                  className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${product.available ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                    }`}
                >
